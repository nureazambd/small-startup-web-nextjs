                    ...
                    <div className="dark:bg-gray-900 bg-gray-50 px-6 py-9">
                        <div className="container mx-auto flex items-center justify-between">
                            ...
                            <ul className="hidden w-8/12 md:flex items-center justify-center space-x-8">
                                ...
                                <li>
                                    <Link href="/services" className="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                                    Services
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/company" className="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                                    Company
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/case-studies" className="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                                    Case studies
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/resources" className="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                                    Resources
                                    </Link>
                                </li>
                            </ul>
                            <div className="md:w-4/12 justify-end flex items-center space-x-4 xl:space-x-8">
                                ...
                                <div className="hidden lg:flex items-center space-x-4 xl:space-x-8">
                                    ...
                                    <Link href="/contactus" aria-label="go to cart" className="text-gray-800 dark:hover:text-gray-300 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800">
